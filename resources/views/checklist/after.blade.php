...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit After Categories</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit After Categories</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <a href="{{route('checklist.show',$id)}}?type=after" class="btn btn-light">Back</a>
            </div>
            <div class="col-sm-12">
                <form action="{{route('checklist.update.after',$id)}}" method="POST">
                @csrf
                @method('PUT')
                ...
                <button type="submit" class="btn btn-primary">Update After Categories</button>
                </form>
            </div>
              <!-- /.col-md-6 -->
        </div>
